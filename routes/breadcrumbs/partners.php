...
Breadcrumbs::for('dashboard.partners.index', function ($breadcrumb) {
    ...
    $breadcrumb->push(trans('partners.plural'), route('dashboard.partners.index'));
});


Breadcrumbs::for('dashboard.partners.trashed', function ($breadcrumb) {
    $breadcrumb->parent('dashboard.partners.index');
    $breadcrumb->push(trans('partners.trashed'), route('dashboard.partners.trashed'));
});


Breadcrumbs::for('dashboard.partners.create', function ($breadcrumb) {
    $breadcrumb->parent('dashboard.partners.index');
    $breadcrumb->push(trans('partners.actions.create'), route('dashboard.partners.create'));
});
...
Breadcrumbs::for('dashboard.partners.edit', function ($breadcrumb, $partner) {
    ...
    $breadcrumb->push(trans('partners.actions.edit'), route('dashboard.partners.edit', $partner));
});
