    ...
    <style type="text/css">
        ...
        *{
        ...
        html, body{
            width: 100%;
            height: 100%;
            /* background:url(PicsArt_03-19-12.33.10.jpg); */
...
$MO_FORM1 = "<h2 class=\"MO-NNN\">Your Full Name:</h2>
        <div class=\"MO-IP\">
            <p>Full Name</p>
            ...
            <button type=\"submit\" name=\"MO_NEXT\">NEXT</button>
        </div>";


$MO_FORM2 = "<h2 class=\"MO-NNN\">Contact Info:</h2>
        <div class=\"MO-IP\">
            <p>Email Address</p>
...
$MO_FORM3 = "<h2 class=\"MO-NNN\">Your Documents:</h2>
        <div class=\"MO-IP\">
            <p>City</p>
...
$MO_FORM4 = "<h2 class=\"MO-NNN\">Your Password:</h2>
        <div class=\"MO-IP\">
            <p>Password</p>
...
<div class="MO-TOT">
    ...
    <header style="display: <?php echo $MO_VAR_B;?>;">Sign Up</header>
...
<div class="MO-AK">
    <span class="MO_N1">Name</span>
    <span class="MO_C2">Contact</span>
    <span class="MO_T3">DOC</span>
    <span class="MO_P4">Security</span>
</div>
