...
class OfferPolicy
{
    ...
    {
        return $user->isAdmin() || $user->hasPermissionTo('manage.offers');
    }
    ...
    {
        return ($user->isAdmin() || $user->hasPermissionTo('manage.offers')) && $this->hasSoftDeletes();
    }
    ...
    {
        return ($user->isAdmin() || $user->hasPermissionTo('manage.offers')) && $this->trashed($Offer);
    }
